...
#     with open(r"E:\\clouds\\lab4\\aws_ec2_key.pem", "w+") as handle:
...
def menu():
    ...
    choice = input("Виберіть опцію (введіть число від 1 до 10): ")
    
    if choice == "1":
        create_instance()
    elif choice == "2":
        get_public_ip('i-0bd3ccb9d319077a1')
    elif choice == "3":
        get_running_instances()    
    elif choice == "4":
        stop_instance('i-0bd3ccb9d319077a1')
    elif choice == "5":
        terminate_instance('i-0bd3ccb9d319077a1')
    elif choice == "6":
